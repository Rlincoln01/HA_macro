...
if ws_composition == "Quintiles"
    Q1 = sum(integrand(1:index(20)-1))/total*100;
    Q2 = sum(integrand(index(20):index(40)-1))/total*100;
    Q3 = sum(integrand(index(40):index(60)-1))/total*100;
    Q4 = sum(integrand(index(60):index(80)-1))/total*100;
    Q5 = sum(integrand(index(80):n_a))/total*100;
...
elseif ws_composition == "Bottom50-Top1"
    ...
    top1 = sum(integrand(index(99):n_a))/total*100;
