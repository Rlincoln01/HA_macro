...
function [V,con,sav,A] = HJB(parameters,r,tau)

%=========================================================================
%                   Calibration, Income and Asset grid
%=========================================================================
...
borrow_lim = parameters.borrow_lim;
...
% Poisson Income transition matrix
...
% Meshgrid of joint states (assets and income)
aa = [a,a,a]; 
yy = ones(I,1)*y;
