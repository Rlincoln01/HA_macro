...
% The New Equilibrium
[r_final,w_final,K_final,dist_final] = calculate_eq(na,ne,P,agrid,borrow_lim,amax,beta,delta,alpha,0.99, ...
    L,l_bar);
...
iter= 0;
cdiff = 1000;
disp("Calculating Transition from A=1 to A=" + 0.99 )
while iter <= max_iter && cdiff > tol_iter    
    ...
    [r_series,w_series] = transition_prices(K_series,0.99,alpha,L,l_bar);
