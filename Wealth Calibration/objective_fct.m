...
if penalty == 0
    ...
    [Y,C,~,K_eq,~,lump_sum,r_eq,...
        w_eq,g_final,a_marg_dist] = stationary_equilibrium(calibration,parameters,specification,a_grid);
    
    % target wealth-income ratio
    wealth_income_ratio = K_eq./Y;
    ...
    sim_moments.debt_to_gdp = debt_to_gdp;
