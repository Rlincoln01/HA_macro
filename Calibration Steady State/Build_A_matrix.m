...
function [A,c] = Build_A_matrix(V,w,r,lump_sum,omega,a_grid,idx,z_grid,tau,parameters)
...
% for j=1:idx
%     c0(j,:) = c0(j,:) - daaf(j,:); % households in the andmissible region save ∆a per period
% end    
...
% 1.6 - Building FD apro ximation of Policy
