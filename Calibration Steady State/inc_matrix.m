...
function [TM_y,ygrid,TM_p,p_grid,TM_t,t_grid] = inc_matrix(parameters)

% ========== Parameters ========== %

n_p = parameters.n_p;
n_t = parameters.n_t;
pgrid_width = parameters.pgrid_width;
tgrid_width = parameters.tgrid_width;
pgrid_par = parameters.pgrid_par;
tgrid_par = parameters.tgrid_par;
sigma_t = parameters.sigma_t;                     
sigma_p = parameters.sigma_p;                     
beta_t = parameters.beta_t;                     
beta_p = parameters.beta_p;                     
lambda_p = parameters.lambda_p;                   
lambda_t = parameters.lambda_t;                    
